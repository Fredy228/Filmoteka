 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const re={asc:"ASCENDING",desc:"DESCENDING"},oe={"<":"LESS_THAN","<=":"LESS_THAN_OR_EQUAL",">":"GREATER_THAN",">=":"GREATER_THAN_OR_EQUAL","==":"EQUAL","!=":"NOT_EQUAL","array-contains":"ARRAY_CONTAINS",in:"IN","not-in":"NOT_IN","array-contains-any":"ARRAY_CONTAINS_ANY"};class ae{constructor(t,e){this.databaseId=t,this.C=e}}function se(t,e){return t.C?`${new Date(1e3*e.seconds).toISOString().replace(/\.\d*/,"").replace("Z","")}.${("000000000"+e.nanoseconds).slice(-9)}Z`:{seconds:""+e.seconds,nanos:e.nanoseconds}}function le(t,e){return t.C?e.toBase64():e.toUint8Array()}function ce(t,e){return se(t,e.toTimestamp())}function ue(t){return g(!!t),ft.fromTimestamp(function(t){const e=_t(t);return new ut(e.seconds,e.nanos)}(t))}function fe(t,e){return(n=t,new $(["projects",n.projectId,"databases",n.database])).child("documents").child(e).canonicalString();var n}function de(t,e){return fe(t.databaseId,e.path)}function he(t,e){const n=function(t){const e=$.fromString(t);return g(ke(e)),e}(e);if(n.get(1)!==t.databaseId.projectId)throw new L(w,"Tried to deserialize key from different project: "+n.get(1)+" vs "+t.databaseId.projectId);if(n.get(3)!==t.databaseId.database)throw new L(w,"Tried to deserialize key from different database: "+n.get(3)+" vs "+t.databaseId.database);var i;return new X((g((i=n).length>4&&"documents"===i.get(4)),i.popFirst(5)))}function pe(t,e){return fe(t.databaseId,e)}function me(t){return new $(["projects",t.databaseId.projectId,"databases",t.databaseId.database]).canonicalString()}function ge(t,e,n){return{name:de(t,e),fields:n.value.mapValue.fields}}function ye(t,e){const n={structuredQuery:{}},i=e.path;null!==e.collectionGroup?(n.parent=pe(t,i),n.structuredQuery.from=[{collectionId:e.collectionGroup,allDescendants:!0}]):(n.parent=pe(t,i.popLast()),n.structuredQuery.from=[{collectionId:i.lastSegment()}]);const r=function(t){if(0===t.length)return;const e=t.map((t=>function(t){if("=="===t.op){if(Lt(t.value))return{unaryFilter:{field:we(t.field),op:"IS_NAN"}};if(Rt(t.value))return{unaryFilter:{field:we(t.field),op:"IS_NULL"}}}else if("!="===t.op){if(Lt(t.value))return{unaryFilter:{field:we(t.field),op:"IS_NOT_NAN"}};if(Rt(t.value))return{unaryFilter:{field:we(t.field),op:"IS_NOT_NULL"}}}return{fieldFilter:{field:we(t.field),op:ve(t.op),value:t.value}}}(t)));return 1===e.length?e[0]:{compositeFilter:{op:"AND",filters:e}}}(e.filters);r&&(n.structuredQuery.where=r);const o=function(t){if(0!==t.length)return t.map((t=>{return{field:we((e=t).field),direction:be(e.dir)};var e}))}(e.orderBy);o&&(n.structuredQuery.orderBy=o);const a=(s=t,l=e.limit,s.C||Z(l)?l:{value:l});var s,l,c;return null!==a&&(n.structuredQuery.limit=a),e.startAt&&(n.structuredQuery.startAt={before:(c=e.startAt).inclusive,values:c.position}),e.endAt&&(n.structuredQuery.endAt=function(t){return{before:!t.inclusive,values:t.position}}(e.endAt)),n}function be(t){return re[t]}function ve(t){return oe[t]}function we(t){return{fieldPath:t.canonicalString()}}function xe(t){const e=[];return t.fields.forEach((t=>e.push(t.canonicalString()))),{fieldPaths:e}}function ke(t){return t.length>=4&&"projects"===t.get(0)&&"databases"===t.get(2)}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
class Re{get _path(){return this._key.path}get id(){return this._key.path.lastSegment()}get path(){return this._key.path.canonicalString()}get parent(){return new Oe(this.firestore,this.converter,this._key.path.popLast())}withConverter(t){return new Re(this.firestore,t,this._key)}constructor(t,e,n){this.converter=e,this._key=n,this.type="document",this.firestore=t}}class Le{withConverter(t){return new Le(this.firestore,t,this._query)}constructor(t,e,n){this.converter=e,this._query=n,this.type="query",this.firestore=t}}class Oe extends Le{get id(){return this._query.path.lastSegment()}get path(){return this._query.path.canonicalString()}get parent(){const t=this._path.popLast();return t.isEmpty()?null:new Re(this.firestore,null,new X(t))}withConverter(t){return new Oe(this.firestore,t,this._path)}constructor(t,e,n){super(t,e,new jt(n)),this._path=n,this.type="collection"}}function De(t,e,...n){if(t=(0,s.getModularInstance)(t),G("collection","path",e),t instanceof Ce){const i=$.fromString(e,...n);return Q(i),new Oe(t,null,i)}{if(!(t instanceof Re||t instanceof Oe))throw new L(w,"Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");const i=t._path.child($.fromString(e,...n));return Q(i),new Oe(t.firestore,null,i)}}function Me(t,e,...n){if(t=(0,s.getModularInstance)(t),1===arguments.length&&(e=st.$()),G("doc","path",e),t instanceof Ce){const i=$.fromString(e,...n);return K(i),new Re(t,null,new X(i))}{if(!(t instanceof Re||t instanceof Oe))throw new L(w,"Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");const i=t._path.child($.fromString(e,...n));return K(i),new Re(t.firestore,t instanceof Oe?t.converter:null,new X(i))}}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Pe{isEqual(t){return this._internalPath.isEqual(t._internalPath)}constructor(...t){for(let e=0;e<t.length;++e)if(0===t[e].length)throw new L(w,"Invalid field name at argument $(i + 1). Field names must not be empty.");this._internalPath=new q(t)}}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Fe{get latitude(){return this._lat}get longitude(){return this._long}isEqual(t){return this._lat===t._lat&&this._long===t._long}toJSON(){return{latitude:this._lat,longitude:this._long}}_compareTo(t){return lt(this._lat,t._lat)||lt(this._long,t._long)}constructor(t,e){if(!isFinite(t)||t<-90||t>90)throw new L(w,"Latitude must be a number between -90 and 90, but was: "+t);if(!isFinite(e)||e<-180||e>180)throw new L(w,"Longitude must be a number between -180 and 180, but was: "+e);this._lat=t,this._long=e}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
async function Pt(t,e,n=!1){var i;const{auth:r}=t,o="reauthenticate";try{const i=await W(t,Mt(r,o,e,t),n);v(i.idToken,r,"internal-error");const a=j(i.idToken);v(a,r,"internal-error");const{sub:s}=a;return v(t.uid===s,r,"user-mismatch"),Lt._forOperation(t,o,i)}catch(t){throw"auth/user-not-found"===(null===(i=t)||void 0===i?void 0:i.code)&&p(r,"user-mismatch"),t}}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function zt(t,e,n=!1){const i="signIn",r=await Mt(t,i,e),o=await Lt._fromIdTokenResponse(t,i,r);return n||await t._updateCurrentUser(o.user),o}function Ft(t,e,n,r){return(0,i.getModularInstance)(t).onAuthStateChanged(e,n,r)}function Ut(t){return(0,i.getModularInstance)(t).signOut()}new WeakMap;const jt="__sak";
/**
 * @license
 * Copyright 2019 Google LLC
 *
