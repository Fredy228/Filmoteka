...
export class Modal {
  ...
  openModal(id, slider = '') {
    ...
    if (slider == 'slider') {
      if (sliderRef.dataset.ids) {
        ...
        sliderRef
          ...
          .forEach(el => ids.push(el.dataset.id));
    ...
    window.filmoteka
      ...
      .then(result => {
        onClickToBtnTrailer(this.filmId).then(hash => {
          this.hash = hash;
            ...
            <div class="modal-film__label">
                ...
                <ul class="modal-film__info">
                    <li class="modal-film__item">
                        <p class="modal-film__item-title" >${
                          this.param.langText.vote
                        }</p>
                    ...
                    <li class="modal-film__item">
                        <p class="modal-film__item-title">${
                          this.param.langText.popularity
                        }</p>
                    ...
                    <li class="modal-film__item">
                        <p class="modal-film__item-title">${
                          this.param.langText.title
                        }</p>
                        <p class="modal-film__item-text">${title}</p>
                    </li>
                    <li class="modal-film__item">
                        <p class="modal-film__item-title">${
                          this.param.langText.genre
                        }</p>
                        <p class="modal-film__item-text">${allGenres}</p>
                    </li>
                </ul>
                <p class="modal-film__about-title">${
                  this.param.langText.about
                }</p>
                ...
                <ul class="modal-film__btn-box">
                    <li class="modal-film__btn-item ${
                      window.movieLibrary.isWatched(this.filmId) ? 'remove' : ''
                        ...
                        <button class="modal-film__watched-button modal-film__btn" aria-label="${
                          this.param.langText.modalWatchedAdd
                        }" type="button" data-watched="${this.filmId}">${
      this.param.langText.modalWatchedAdd
    }</button>
                        <button class="modal-film__watched-buttonr modal-film__btn" aria-label="${
                          this.param.langText.modalWatchedRemove
                        }" type="button" data-watchedr="${this.filmId}">${
      this.param.langText.modalWatchedRemove
    }</button>
                    </li>
                    <li class="modal-film__btn-item ${
                      window.movieLibrary.isQueue(this.filmId) ? 'remove' : ''
                        ...
                        <button class="modal-film__queue-button modal-film__btn" aria-label="${
                          this.param.langText.modalQueueAdd
                        }" type="button" data-queue="${this.filmId}">${
      this.param.langText.modalQueueAdd
    }</button>
                        <button class="modal-film__queue-buttonr modal-film__btn" aria-label="${
                          this.param.langText.modalQueueRemove
                        }" type="button" data-queuer="${this.filmId}">${
      this.param.langText.modalQueueRemove
    }</button>
                    </li>
                </ul>
  ...
  checkLibrary() {
    if (
      window.location.pathname ==
        '/filmoteka_mriia_goit_project/partials/library-pg.html' ||
      window.location.pathname == '/partials/library-pg.html'
    ) {
